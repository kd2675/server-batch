package com.example.batch.service.batch.database;
...
@EnableJpaRepositories(
        basePackages = "com.example.batch.service.batch.database.rep.jpa",
...
public class BatchDataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean batchEntityManagerFactory(
        ...
        return builder.dataSource(new LazyConnectionDataSourceProxy(routingDataSource))
                .packages("com.example.batch.service.batch.database.rep.jpa")
